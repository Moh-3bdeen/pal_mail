...
import 'package:pal_mail/screens/all_mails_of_status.dart';
import 'package:pal_mail/screens/details_screen.dart';
...
class TagContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: isSelected ? kMainColorLight : Colors.black38,
